...
一款轻量级的 Markdown、纯文本、轻量 HTML 与 PPT 设计整理工具，基于 Wails (Go + Vue 3) 构建。当前版本 `v1.0.4`，详细更新见 [docs/更新日志.md](docs/更新日志.md)。
...
| <strong><big>工作区搜索与结果定位</big></strong> | 支持在当前文件与工作区文件中搜索关键词，按文件分组展示命中结果，可区分大小写、全字段匹配，并点击结果跳转到对应内容位置 |
...
| <strong><big>AI PPT 生成与编辑</big></strong> | 可将当前文档生成可编辑 PPT，支持内容密度、自动规划或指定页数、参考图片风格分析、分批生成、实时进度、失败后继续生成，以及已有版本打开或重新生成 |
