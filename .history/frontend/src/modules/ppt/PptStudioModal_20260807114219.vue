        ...
        >
          <section class="ppt-slide-ai-dialog">
            ...
            <div class="ppt-reference-block ppt-reference-block-slide">
              ...
              <small>可只上传参考图，AI 会根据图片的风格和版式重新设计当前页。</small>
            </div>
...
.ppt-modal { width: min(620px, 100%); max-height: calc(100vh - 48px); overflow: hidden; border: 1px solid rgba(15, 23, 42, .14); border-radius: 8px; background: #fff; box-shadow: 0 24px 80px rgba(15, 23, 42, .28); }
